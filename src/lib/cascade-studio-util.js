...
export function CheckCache(hash) { return argCache[hash] || null; }
/** Adds this `shape` to the cache, indexable by `hash`. */
export function AddToCache(hash, shape) {
...
export function ComputeHash(args, raw) {
...
export function recursiveTraverse(x, callback) {
