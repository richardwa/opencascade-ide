...
import { CacheOp } from './cascade-studio-util';
import { opencascade as oc } from './opencascade-util';
...
export function Difference(mainBody, objectsToSubtract, keepObjects, fuzzValue, keepEdges) {
  if (!fuzzValue) { fuzzValue = 0.1; }
...
export function SaveFile(filename, fileURL) {
  postMessage({
    "type": "saveFile",
